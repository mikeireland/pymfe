...
badpixel_mask= pyfits.getdata('/home/jbento/code/pymfe/badpix.fits')
badpix=np.where(badpixel_mask==1)

# Initialise objects
rhea2_format = pymfe.rhea.Format()
rhea2_extract = pymfe.Extractor(rhea2_format, transpose_data=False,badpixmask=badpix)
...
out_path = base_path + "/thar_extracted_badpix/"
...
rv.save_ref_spect(extracted_files, ref_spect, vars, wave_ref, bcors, mjds, out_path)                                          
